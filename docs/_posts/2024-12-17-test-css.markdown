...
It explains the code and also gets into some of the model parametrization and how that affects its behavior. Not surprising, but still shows this is truly useful for a Model Validation. And the analysis of the performance in time, good too.