...
**Some** suggestions were more **software-engineering**-focused, but they **also** included important validation aspects like parameter justification and data checks. 
